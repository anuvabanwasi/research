...
co = generate_evenly_spaced_seeds(5, min_x, max_x, min_y, max_y)

#co = [(10000, 10000)]
for r in radius:

    clusters_fastq_file_name = 'Clusters_' + base_file_name + "_" + str(r) + '.fasta'

    find_nearby_clusters(l, co, r, clusters_fastq_file_name)

    # Create output file names

    output_file_name = 'output_' + base_file_name + "_" + str(r) + '.txt'
    
    output_filtered_file_name = 'output_filtered_' + base_file_name + "_" + str(r) + '.txt'
